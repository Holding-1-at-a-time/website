...
const service = getServiceBySlug("full-body-wash");
...
export const metadata: Metadata = {
    ...
    openGraph: {
        ...
        description: service.metaDescription,
        type: "website",
        url: `https://1detailatatime.com/services/full-body-wash`,
    },
    alternates: {
        canonical: `https://1detailatatime.com/services/full-body-wash`,
    },
};
